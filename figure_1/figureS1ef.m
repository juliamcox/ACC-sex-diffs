...
% Analyze latency modulation by weight 
...
% All animal IDs 
ids_f_all = generateAnimalList('ACC_DMS_nphr_female');
ids_f_all = cat(1,ids_f_all,generateAnimalList('ACC_DMS_nphr_yfp_female'));
ids_f_all = cat(1,ids_f_all,generateAnimalList('DMS_nphr_d1_female'));
ids_f_all = cat(1,ids_f_all,generateAnimalList('DMS_nphr_d2_female'));
ids_f_all = cat(1,ids_f_all,generateAnimalList('DMS_yfp_female')); 

ids_m_all = generateAnimalList('ACC_DMS_nphr_male');
ids_m_all = cat(1,ids_m_all,generateAnimalList('ACC_DMS_nphr_yfp_male'));
ids_m_all = cat(1,ids_m_all,generateAnimalList('DMS_nphr_d1_male'));
ids_m_all = cat(1,ids_m_all,generateAnimalList('DMS_nphr_d2_male'));
ids_m_all = cat(1,ids_m_all,generateAnimalList('DMS_yfp_male')); 
