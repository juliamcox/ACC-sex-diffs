...
X = table(behaviorTable.choice(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0)), categorical(behaviorTable.female(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))),...
    categorical(behaviorTable.aID(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))),...
    categorical(thisValue_ptile(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))), categorical(behaviorTable.opsin(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))), categorical(behaviorTable.laser(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))),...
    categorical(behaviorTable.previousReward(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))),nanzscore(behaviorTable.trial(behaviorTable.laserSession==1&(behaviorTable.laser==laserType | behaviorTable.laser==0))), 'VariableNames',{'Choice';'Sex';'Animal';'Value';...
    'Opsin';'Laser';'PrevOutcome';'Trial'});

f = 'Choice ~ Laser*Opsin*Value*Sex + Trial + (1+Value|Animal)';
stats.mdl = fitglme(X,f,'Distribution','binomial','DummyVarCoding','effects');
