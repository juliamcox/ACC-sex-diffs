function [pval, chi2stat, posthoc] = plotPerEncoding_maleFemale(recs_f,recs_m,ver,frameRate, rawFlag, zscoreFlag,whichEvent,expt)
...
savehere = fullfile(fbasename,fname); %generate save location
