...
plotParams    = load(fullfile(whereAreWe('data'),'plotParams.mat')); % load plot parameters 
...
writetable(tbl_f,fullfile(whereAreWe('data'),'stats_tables','qmodel_f.csv'))
writetable(tbl_m,fullfile(whereAreWe('data'),'stats_tables','qmodel_m.csv'))
