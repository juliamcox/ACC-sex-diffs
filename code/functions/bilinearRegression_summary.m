...
save(fullfile(fbasename,regVer,'summary.mat'),'fnames','thisFnames','thisFnames_m','chi2_pval','chi2stat','numSig','numSig_m','pvals','pvals_m','model_r2','model_r2_m','coeffs','coeffs_m','-append');
